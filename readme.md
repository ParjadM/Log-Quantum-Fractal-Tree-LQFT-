...
- v1.1.1 is a better write-heavy LQFT than v1.0.9.
- v1.1.1 is not a proof that LQFT beats common in-memory data structures overall.

---

## Performance Snapshot (v1.1.1)
